...
import structformer.training.train_structformer_no_structure as prior_model
    ...
    with tqdm.tqdm(total=len(test_dataset)) as pbar:
        ...
        for idx in range(len(test_dataset)):
            ...
            for b in range(beam_size):
                ...
                beam_pc_rearrangements.append(PointCloudRearrangement(datum, use_structure_frame=False))
            ...
            # iteratively predict pose of each object
            beam_goal_obj_poses = []
            for obj_idx in range(num_target_objects):
                target_object_preds = prior_inference.limited_batch_inference(beam_data)
            ...
            for bi in range(beam_size):
                beam_pc_rearrangements[bi].set_goal_poses(None, beam_goal_obj_poses[bi])
...
if __name__ == "__main__":
    ...
    # args.dirs_config = "/home/weiyu/Research/intern/StructFormer/structformer/configs/data/dinner_dirs.yaml"
